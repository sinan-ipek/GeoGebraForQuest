...
internal sealed class MainForm : Form
{
    ...
    private async Task InitializeWebViewAsync()
    {
        try
        {
            ...
            var boot = Path.Combine(AppContext.BaseDirectory, "assets", "web", "GeoGebra", "web3d", "web3d.nocache.js");
            ...
            (function () {
              ...
              if (!document.getElementById('ggq-pc-stereo-layout')) {
                ...
                tag.onerror = function () {
                  try {
                    window.chrome.webview.postMessage({ type: 'runtimeError', message: 'quest-stereo-layout.js yüklenemedi' });
                  } catch (e) {}
                };
