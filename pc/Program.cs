...
internal static class Program
{
    ...
    private static void Main()
    {
        try
        {
            ...
            File.WriteAllText(
                LogPath,
                $"GeoGebraForQuest PC v0.8.0 B-Panel Diagnostic startup\r\n" +
        ...
        try
        {
            ...
            mainForm.Text = "GeoGebraForQuest PC · v0.8.0 · B-Panel Diagnostic";
    ...
    private static void ShowFatal(string stage, Exception exception)
    {
        ...
        try
        {
            MessageBox.Show(
                message,
                "GeoGebraForQuest PC v0.8.0 - Başlatma Hatası",
