...
if old_emit not in t:
    raise SystemExit('v0.13.4 keyboard edit block not found')
...
# Replace v0.13.4 triangle raster with a 45-degree CCW rotated version.
...
# Replace both visual cursor paths with one effective cursor.
