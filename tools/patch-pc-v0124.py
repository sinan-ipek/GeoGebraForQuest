...
for file in ('pc/MainFormV11.cs', 'pc/GeoGebraForQuest.PC.csproj', 'pc/build.ps1'):
    ...
    text = text.replace(r'0\.12\.3-xr-behind-native', r'0\.12\.4-input-panel-quality')
    text = text.replace('v0.12.3', 'v0.12.4')
    text = text.replace(r'v0\.12\.3', r'v0\.12\.4')
    ...
    text = text.replace(r'main-v123\.cpp', r'main-v124\.cpp')
