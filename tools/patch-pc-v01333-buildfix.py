...
The architectural patch is frozen at commit 9d273acca509f9370f8b4f98d0e3b72a19065ea5.
This wrapper only relaxes one brittle multi-line source matcher in the A-share
ownership fix. It keeps the behavior identical: XR sharing is sourced from the
client-owned `target` texture rather than CefSharp's temporary pool texture.
"""
